        ...
        SendMessageRequest source = new SendMessageRequest(
                ...
                new NewMessageBody(
                        ...
                        List.of(NewMessageAttachment.inlineKeyboard(new InlineKeyboardAttachment(List.of(
                                List.of(new InlineKeyboardButtonRequest("Pay", "pay:1", null, null, null, null, null, null)),
                                List.of(new InlineKeyboardButtonRequest("Site", null, null, "https://example.com", null, null, null, null))
                        ))))
                ),
                true,
                null
