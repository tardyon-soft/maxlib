...
import ru.tardyon.botframework.fsm.SceneSession;
import ru.tardyon.botframework.fsm.SceneStateBinding;
import ru.tardyon.botframework.fsm.SceneNotFoundException;
import ru.tardyon.botframework.fsm.StateScope;
import ru.tardyon.botframework.fsm.Wizard;
import ru.tardyon.botframework.fsm.WizardFlowException;
import ru.tardyon.botframework.fsm.WizardManager;
import ru.tardyon.botframework.fsm.WizardStep;
...
class DispatcherInvocationPipelineIntegrationTest {
    ...
    void runtimePipelineSupportsSceneEnterNextExitLifecycle() {
        ...
        ru.tardyon.botframework.fsm.StateKey key = ru.tardyon.botframework.fsm.StateKeyStrategies.userInChat().resolve(enterUpdate);
