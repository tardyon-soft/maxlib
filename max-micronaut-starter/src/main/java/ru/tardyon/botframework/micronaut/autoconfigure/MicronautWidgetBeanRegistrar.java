...
/**
 * Discovers {@link WidgetController}-annotated classes even without explicit bean declaration.
 */
@Singleton
public final class MicronautWidgetBeanRegistrar {
    private final ApplicationContext applicationContext;

    public MicronautWidgetBeanRegistrar(ApplicationContext applicationContext) {
        this.applicationContext = applicationContext;
    }

    public List<Object> discoverWidgetControllerInstances() {
        ...
        for (String basePackage : basePackages) {
            for (Class<?> candidate : scanClasses(basePackage)) {
                WidgetController controller = candidate.getAnnotation(WidgetController.class);
    ...
    private void loadIfCandidate(String className, List<Class<?>> classes) {
        try {
            ...
            if (candidate.isAnnotationPresent(WidgetController.class)
