...
/**
 * Discovers {@link Screen}-annotated bean classes and resolves actual Micronaut beans for them.
 */
@Singleton
public final class MicronautScreenBeanRegistrar {
    private final ApplicationContext applicationContext;

    public MicronautScreenBeanRegistrar(ApplicationContext applicationContext) {
        this.applicationContext = applicationContext;
    }

    public List<Object> discoverScreenBeans() {
        ...
        for (String basePackage : basePackages) {
            for (Class<?> candidate : scanClasses(basePackage)) {
                Screen screen = candidate.getAnnotation(Screen.class);
    ...
    private void loadIfCandidate(String className, List<Class<?>> classes) {
        try {
            ...
            if (candidate.isAnnotationPresent(Screen.class)
